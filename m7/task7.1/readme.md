...
<img src="./screenshot/networkscan_all.png" width="80%" >

> Running script with --target key
<img src="./screenshot/networkscan_target.png" width="80%" >

2. Reading apache_log.log

To see code follow this [link]()
...
> Create data
<img src="./screenshot/data.png" width="80%" >

> Create backup
<img src="./screenshot/backupscript.png" width="80%" >
